...
public class Solution implements Serializable {  
  ...
  /**
   * 这是一个新的值，主要是为HyPE算法准备的，主要保存HypeIndicator值
   */
  private double hypeIndicatorValue_;
...
//    variable_ = type_.copyVariables(solution.variable_) ;
  ...
  public double getHypeIndicatorValue_() {
	return hypeIndicatorValue_;
  }

  public void setHypeIndicatorValue_(double hypeIndicatorValue_) {
	this.hypeIndicatorValue_ = hypeIndicatorValue_;
  }
...
public int hashCode() {
	...
	int result = 1;
	long temp;
	temp = Double.doubleToLongBits(crowdingDistance_);
	result = prime * result + (int) (temp ^ (temp >>> 32));
	temp = Double.doubleToLongBits(distanceToSolutionSet_);
	result = prime * result + (int) (temp ^ (temp >>> 32));
	temp = Double.doubleToLongBits(fitness_);
	result = prime * result + (int) (temp ^ (temp >>> 32));
	temp = Double.doubleToLongBits(kDistance_);
	result = prime * result + (int) (temp ^ (temp >>> 32));
	result = prime * result + location_;
	result = prime * result + (marked_ ? 1231 : 1237);
	result = prime * result + numberOfObjectives_;
	result = prime * result + numberOfViolatedConstraints_;
	result = prime * result + Arrays.hashCode(objective_);
	temp = Double.doubleToLongBits(overallConstraintViolation_);
	result = prime * result + (int) (temp ^ (temp >>> 32));
	result = prime * result + ((problem_ == null) ? 0 : problem_.hashCode());
	result = prime * result + rank_;
	result = prime * result + ((type_ == null) ? 0 : type_.hashCode());
	result = prime * result + Arrays.hashCode(variable_);
	return result;
}
...
public boolean equals(Object obj) {
	...
	if (Double.doubleToLongBits(crowdingDistance_) != Double
			.doubleToLongBits(other.crowdingDistance_))
		return false;
	if (Double.doubleToLongBits(distanceToSolutionSet_) != Double
			.doubleToLongBits(other.distanceToSolutionSet_))
		return false;
	if (Double.doubleToLongBits(fitness_) != Double
			.doubleToLongBits(other.fitness_))
		return false;
	if (Double.doubleToLongBits(kDistance_) != Double
			.doubleToLongBits(other.kDistance_))
		return false;
	if (location_ != other.location_)
		return false;
	if (marked_ != other.marked_)
		return false;
	if (numberOfObjectives_ != other.numberOfObjectives_)
		return false;
	if (numberOfViolatedConstraints_ != other.numberOfViolatedConstraints_)
		return false;
	if (!Arrays.equals(objective_, other.objective_))
		return false;
	if (Double.doubleToLongBits(overallConstraintViolation_) != Double
			.doubleToLongBits(other.overallConstraintViolation_))
		return false;
	if (problem_ == null) {
		if (other.problem_ != null)
			return false;
	} else if (!problem_.equals(other.problem_))
		return false;
	...
	if (type_ == null) {
		...
		return false;
	if (!Arrays.equals(variable_, other.variable_))
		return false;
	return true;
}
