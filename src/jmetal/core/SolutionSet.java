...
public class SolutionSet implements Serializable {
  ...
  public SolutionSet(SolutionSet solutionset) {
	  solutionsList_ = new ArrayList<Solution>();
	  capacity_ = solutionset.capacity_;
	  Iterator iterator = solutionset.iterator();
	  while(iterator.hasNext()){
		  Solution solution1 = (Solution) iterator.next();
		  Solution solution = new Solution(solution1);
