...
public class RunExperiment extends Thread {
	...
	public int numberOfFile_;

	// Inicio modificaci車n planificaci車n Threads
	static boolean finished;
	// Fin modificaci車n planificaci車n Threads
	...
	public void run() {
		...
		SolutionSets resultFronts = null;
...
//				this.numberOfFile_ = resultFronts.size();
//				for(int i = 0 ; i < numberOfFile_ ; i++){		
//					SolutionSet solutionset =  resultFronts.get(i);
//					solutionset.printObjectivesToFile(directory + "/" + outputParetoFrontFile_ + i + "." + runs);
//					solutionset.printVariablesToFile(directory + "/" + outputParetoSetFile_ + i + "." + runs);
//				}
